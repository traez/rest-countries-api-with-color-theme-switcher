/* 
The DetaiDesktop component is a part of the codebase that contributes to displaying detailed information about a specific country, specifically tailored for Desktop devices. It leverages the data provided by the StateContext from the StateProvider to fetch and present the relevant country details.
*/
      ...
      <main className="mdl-main">
        <aside className={`dd${isDarkMode ? "d" : "l"}-aside`}>
          ...
          <menu className="mhl-menu">
            ...
            <div
              className={`dd${isDarkMode ? "d" : "l"}-mode`}
        ...
        <section className="ddl-sec">
          <div
            className={`dd${isDarkMode ? "d" : "l"}-arrowback`}
            onClick={() => {
              router.push(`/`);
            }}
          >
          ...
          <div className="ddl-flagcontainer">
            <Image
          ...
          <div className="ddl-wheredata">
            <div className="ddl-infobloc1">
